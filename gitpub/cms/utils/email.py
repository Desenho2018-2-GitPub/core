...
class EmailSender(object):
    ...
    def __new__(cls, *kwargs):
        ...
        EmailSender._instance.email_connection = smtplib.SMTP(host='smtp.office365.com', port=587)
        EmailSender._instance.email_connection.starttls()
        EmailSender._instance.email_connection.login('gitpubapp@hotmail.com', 'MileneMauricio')
